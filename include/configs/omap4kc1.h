...
#define Q_BOOTARGS "console=ttyO2,115200n8 mem=456M@0x80000000" \
            " init=/init root=/dev/mmcblk0p4 vram=5M omapfb.vram=0:5M androidboot.console=ttyO2"

#define Q_BOOTCOMMAND "mmcinit 1;mmc 1 read 0x400 0x81000000 0x600000;bootm 0x81000000"
...
/* Fastboot variables */
#define CFG_FASTBOOT_TRANSFER_BUFFER (PHYS_SDRAM_1 + SZ_48M)
...
/* Allow command editing to support Up/Down arrow */
#define CONFIG_CMDLINE_EDITING  1

#define CONFIG_GPIO_ENTRY_UBOOT 1
#endif                           /* __CONFIG_H */
